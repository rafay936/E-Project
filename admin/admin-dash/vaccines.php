        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="javascript:void(0);" class="action-btn" onclick="editVaccine('<?php echo $vaccine['vaccine_id']; ?>','<?php echo htmlspecialchars($vaccine['vaccine_name'], ENT_QUOTES); ?>','<?php echo htmlspecialchars($vaccine['vaccine_type'], ENT_QUOTES); ?>','<?php echo $vaccine['quantity']; ?>')">Edit</a>
              </td>
            </tr>
            <?php endwhile; ?>
          </tbody>
