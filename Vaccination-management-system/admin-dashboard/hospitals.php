...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'admin') {
  header('Location: admin/vms/login.php'); // Adjust to your login path
  exit;
}
...
<body>
                ...
                <td>
                  ...
                  <?php if ($availableBeds < 15): ?>
                    ...
                    <button class="btn btn-sm btn-theme"
                      onclick="openAssignBedsModal('<?php echo $hospital_id; ?>')">Add/Assign Beds</button>
                  <?php endif; ?>
                </td>
                <td>
                  ...
                  <?php if ($availableVaccines < 15): ?>
                    <br>
                    <button class="btn btn-sm btn-theme"
                      onclick="openAssignVaccinesModal('<?php echo $hospital_id; ?>')">Add/Assign Vaccines</button>
                  <?php endif; ?>
                </td>
                <td>
                  <button class="btn btn-sm btn-theme"
                    onclick="openEditModal('<?php echo $hospital_id; ?>', '<?php echo addslashes($hospital['hospital_name']); ?>', '<?php echo addslashes($hospital['address']); ?>')">Edit</button>
                  <a href="delete_hospital.php?hospital_id=<?php echo $hospital_id; ?>" class="btn btn-sm btn-theme"
  ...
  <!-- Edit Hospital Modal -->
  <div class="modal fade" id="editHospitalModal" tabindex="-1" role="dialog" aria-labelledby="editHospitalModalLabel"
    aria-hidden="true">
  ...
  <!-- Assign Beds Modal -->
  <div class="modal fade" id="assignBedsModal" tabindex="-1" role="dialog" aria-labelledby="assignBedsModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
  ...
  <div class="modal fade" id="assignVaccinesModal" tabindex="-1" role="dialog"
    aria-labelledby="assignVaccinesModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
